...
jq '.channel_group.groups.Application.groups."orgA-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.0.26","port": 7054}]},"version": "0"}}' jornada_current_config.json > jornada_modified_anchor_config.json
