...
type SituacaoAtividade string

const (
	EAtividadeAprovado  SituacaoAtividade = "Aprovado"
	EAtividadeReprovado SituacaoAtividade = "Reprovado"
	EAtividadePendente  SituacaoAtividade = "Pendente"
)
...
type SituacaoEstagio string

const (
	EEstagioAprovado  SituacaoEstagio = "Aprovado"
	EEstagioReprovado SituacaoEstagio = "Reprovado"
	EEstagioPendente  SituacaoEstagio = "Pendente"
)
...
type Estagio struct {
	...
	Certificado                string          `json:"certificado"`
	Situacao                   SituacaoEstagio `json:"situacao"`
}
...
type DadosRegulatoriosIES struct {
	InstituicaoEnsino InformacoesRegulatoriasIES `json:"instituicaoEnsino"`
...
// All Possibilities for CategoriaOrganizacao
const (
...
// All Possibilities for Modalidade Curso
const (
...
// All Possibilities for PeriodicidadeCurso
const (
...
// DadosMinimosIES have minimum data about the IES that have the course.
type PerfilDoEstudante struct {
	NomeDeUsuario string `json:"nome"`  // required, login
	Email         string `json:"email"` // required
	Senha         string `json:"senha"` // required
