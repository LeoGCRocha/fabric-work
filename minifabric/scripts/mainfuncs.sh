...
OPNAMES=([up]="$LINE0$LINE1" [netup]='imageget,certgen,netup,netstats' \
  ...
  [appdecree]='appdecree' [appacademic]='appacademic' \
...
function printHelp() {
  ...
  echo "      - 'appacademic'  - runs academicRecords application"
  echo "      - 'appdecree'  - runs decree application"
  echo "      - 'appstudent'  - runs student application"
  echo ""
  echo "    options:"
